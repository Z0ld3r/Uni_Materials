...
public class TestWorkshop
{
    ...
    public void TestStructure()
    {
        ...
        Assert.AreSame(w, g.Workshop, "Workshop constructor should set up Goldsmith.Workshop property", "Workshop constructor sets up Goldsmith.Workshop property");
    }
    ...
    public void TestSellJewelry()
    {
        ...
        Workshop w = new Workshop("titok", o);
